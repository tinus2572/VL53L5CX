...
use vl53l5cx::{
    consts::{
        ...
        VL53L5CX_NB_THRESHOLDS, 
        VL53L5CX_LAST_THRESHOLD},
...
fn write_results(tx: &mut Tx<USART2>, results: &ResultsData, width: usize) {
    ...
    writeln!(tx, "VL53L5A1 Simple Ranging demo application\n").unwrap();
    ...
    for j in 0..width {
        ...
        #[cfg(not(any(feature="VL53L5CX_DISABLE_SIGNAL_PER_SPAD", feature="VL53L5CX_DISABLE_AMBIENT_PER_SPAD")))]
        {
            for i in 0..width {
...
fn main() -> ! {
    ...
    let address: SevenBitAddress = VL53L5CX_DEFAULT_I2C_ADDRESS;
    ...
    thresholds[resolution as usize].zone_num |= VL53L5CX_LAST_THRESHOLD;
